#!/usr/bin/env python3
"""Exercise the seeded P58 PI active-subspace pipeline and MI-POD."""
...
with isolated_example("1dk") as workdir:
    ...
    problem = P58Problem(workdir, nprocs=1, ntrain=10, ntest=1)
...
print(f"ROM_P58_PI_OMMI_K_REL_ERROR={ommi_k_relative_error:.16e}")
print(f"ROM_P58_PI_OMMI_FLUX_REL_ERROR={ommi_flux_relative_error:.16e}")
print(f"ROM_P58_PI_MIPOD_K_REL_ERROR={mipod_k_relative_error:.16e}")
print(f"ROM_P58_PI_MIPOD_FLUX_REL_ERROR={mipod_flux_relative_error:.16e}")
